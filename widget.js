...
cprequire_test(["inline:com-chilipeppr-widget-eagle-debug"], function (ew) {
...
cpdefine("inline:com-chilipeppr-widget-eagle-debug", ["chilipeppr_ready", "Clipper", "jqueryuiWidget"], function () {
    return {
        /**
                ...
                while(isStillAPath) {
                    ...
                    if (deflatePath.length > 0) {
                        ...
                        if (lastDeflatePath != null) {
                            ...
                            // get center
                            var centroid = this.getCentroid(mesh.children[1]);
